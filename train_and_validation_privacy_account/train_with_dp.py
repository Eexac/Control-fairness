...
from train_and_validation_privacy_account.validation import validation_per_sample
import numpy as np
            ...
            if min_index > 0:
                ...
                with torch.no_grad():
                    for gradient1, gradient2 in zip(gradients_clipped, gradients):
                        ...
                        gradient2 = (noise_multiplier * gradient1 + (sigma_t - noise_multiplier) * gradient2) / (
                            sigma_t)
